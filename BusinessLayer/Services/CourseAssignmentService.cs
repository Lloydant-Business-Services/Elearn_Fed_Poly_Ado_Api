...
{
    public class CourseAssignmentService : ICourseAssignment
    {
        ...
        public CourseAssignmentService(IConfiguration configuration, ELearnContext context, IFileUpload fileUpload)
        {
